        ...
        <div className="mt-7 rounded-xl border-l-4 border-[#F2C94C] bg-[#F5FAF7] px-5 py-4">
          ...
          <div className="mt-3 grid min-w-0 gap-2 text-sm text-gray-700 sm:grid-cols-2 [&>p]:min-w-0 [&>p]:break-words [&>p]:[overflow-wrap:anywhere]">
            <p>
              ...
              {formatVisibleInteger(result.candidateOutputsBeforeOverhead)}
            </p>

            <p>
              Candidate outputs billed:{" "}
              {formatVisibleInteger(result.candidateOutputs)}
            </p>

            <p>
              Model-grader calls: {formatVisibleInteger(result.graderCalls)}
            </p>

            <p>
              Human reviews:{" "}
              {formatVisibleInteger(result.selectiveHumanReviews)}
            </p>

            <p>
              Human-review hours: {formatVisibleNumber(result.reviewHours)}
            </p>

            <p>
              Full-review hours: {formatVisibleNumber(result.fullReviewHours)}
            </p>
          </div>
        </div>
        ...
        stats={
          <div className="grid min-w-0 gap-4 sm:grid-cols-3">
            <ResultStat
              ...
              value={
                result.hasAnyPrice
                  ? formatVisibleMoney(result.costPerEvaluationItem)
                  : "—"
              }
            />
            ...
            <ResultStat
              ...
              value={
                result.hasAnyPrice
                  ? formatVisibleMoney(result.costPerCandidateOutput)
                  : "—"
              }
            />
            ...
            <ResultStat
              ...
              value={
                result.hasAnyPrice
                  ? formatVisibleMoney(result.firstYearCost)
                  : "—"
              }
            />
          </div>
        ...
        totals={
          <div className="min-w-0 break-words text-sm leading-relaxed text-gray-600 [overflow-wrap:anywhere]">
            ...
            <p className="mt-2">
              ...
              <span className="font-medium text-gray-900">
                {result.hasAnyPrice
                  ? formatVisibleMoney(result.costPerEvaluationRun)
                  : "—"}
              </span>
            </p>
            ...
            <p className="mt-2">
              ...
              <span className="font-medium text-gray-900">
                {result.hasModelPrices
                  ? formatVisibleMoney(result.modelCost)
            ...
            <p className="mt-2">
              ...
              <span className="font-medium text-gray-900">
                {result.hasHumanRate
                  ? formatVisibleMoney(result.fullHumanReviewCost)
            ...
            <p className="mt-2">
              ...
              <span className="font-medium text-gray-900">
                {result.hasHumanRate
                  ? formatVisibleMoney(result.selectiveReviewLabourSaving)
                  : "Enter the reviewer rate"}
              </span>
            </p>
